...
class GiftItemDropdown extends StatelessWidget {
  const GiftItemDropdown({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<TextFieldController>(builder: (controller) {
      return DropdownButton(
          ...
          onChanged: (value) {
            ...
            controller.giftTypeChange(value);
          });
    });
  }
}
