    ...
    return PopScope(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Guest List with Money as a gift',
          ...
          GetBuilder<ModelClassController>(
              //without GetBuilder data will not live update in this money screen
              builder: (modelController) {
            return GuestListWithGiftTypeFilter(
              giftType: modelController.filterGuestGiftType(GiftType.money),
            );
          }),
        ],
      ),
